    ...
    <>
      <div className="col-md-6">
        <div className="about-me">
          ...
          Desde entonces, me dedico al desarrollo multiplataforma, trabajando con herramientas modernas como React y React Native para crear aplicaciones web y móviles que combinan funcionalidad, diseño y experiencia de usuario.
          </p>
          <p>
          Mi transición desde el ámbito académico a la industria tecnológica no ha mermado mi pasión por aprender. Mantengo un compromiso constante con la formación y actualización de mis habilidades, explorando nuevas tecnologías y herramientas que puedan enriquecer mi perfil profesional. 
          Esto no solo me permite adaptarme a los cambios del sector, sino también aportar soluciones innovadoras en cada proyecto en el que participo.
          </p>
        </div>
      </div>
    </>
